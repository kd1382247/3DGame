#include "SwarmParameter.h"

#include"json.hpp"
#include<fstream>


void SwarmParameter::Init()
{
	LoadFromJson();
}

void SwarmParameter::DrawInspecter()
{
	// HP
...
void SwarmParameter::SaveToJson()
{
	...
	std::ofstream file("Asset/Data/Enemy/Swarm/Parameter/SwarmParameter.json");
	...
	{
		OutputDebugStringA("Swarm parameter save filed\n");
...
void SwarmParameter::LoadFromJson()
{

	std::fstream file("Asset/Data/Enemy/Swarm/Parameter/SwarmParameter.json");
